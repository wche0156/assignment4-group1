...
```{r diet-composition, message = FALSE, warning = FALSE, out.width = '75%', fig.align = "center", fig.width = 8, fig.cap ="Kilocalories per Person per Day in Australia"}
# data figure1
...
```{r worldmap, message = FALSE, warning = FALSE, out.width = '75%', fig.align = "center", fig.width = 8, fig.cap ="Year: {closest_state}"}
# read world map data
