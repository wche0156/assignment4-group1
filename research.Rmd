...
In conclusion, from Table 2,3 and Figure\@ref(fig:Distribution-of-Protein-Fat-Carbohydrates-boxplot) Figure\@ref(fig:Calories-Intake-of-over-the-years) and Figure\@ref(fig:Fat-Calories-Intake-of-over-the-years) we can find that the UK has done a lot of effective work and achieved good results in protecting nature.
...
Unger, R., DeKleermaeker, M., Gidding, S.S. and Christoffel, K.K., 1992. Calories count: improved weight gain with dietary intervention in congenital heart disease. American Journal of Diseases of Children, 146(9), pp.1078-1084.

Lands, W.E., Hamazaki, T., Yamazaki, K., Okuyama, H., Sakai, K., Goto, Y. and Hubbard, V.S., 1990. Changing dietary patterns. The American Journal of Clinical Nutrition, 51(6), pp.991-993.
