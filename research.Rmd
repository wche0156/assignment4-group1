...
```{r US, tab.cap="Calories Intake of United States"}
summary_US <- US_Data %>% 
...
```{r Japan, tab.cap="Calories Intake of Japan"}
...
```{r totalCal, fig.cap= "Calories Intake of over the years", warning=FALSE}
...
```{r fat, fig.cap= "Fat Calories Intake of over the years", warning=FALSE}
